...
<head>
    <meta charset="UTF-8">
    <title>Mi primer proyecto CodeIgniter 4!</title>
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="http://localhost:8888/codeigniter/public/home">Home</a></li>
            <li class="menu-item hidden"><a href="http://localhost:8888/codeigniter/public/about">About</a></li>
            <li class="menu-item hidden"><a href="http://localhost:8888/codeigniter/public/news">News</a></li>
